...
def antispam_group_disallowed_callback(bot, call, handlers):
    ...
    def handle_ban_user_from_group_callback(call):
        if 'banUserFromGroupCallback' in handlers:
            handlers['banUserFromGroupCallback'].ban_user_from_group_callback(bot, call)